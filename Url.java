...
public class Url
{
	...
	/**
	 * Instantiates a new url. Create a new URL according to website address
	 * 
	...
	/**
	 * Parses the website address Three rules of an website address: 1: Must
	 * start with "http://" 2: Must not consist "www."
	 * 
	 * @param websiteAddress the website address
	 * @return the string
	 */
	...
	private String getPathByAddress(String websiteAddress)
	{
		...
		if (index1 != -1 && index1 != websiteAddress.length() - 1)
		{
			return websiteAddress.substring(index1);
		}
		else
		{
			return "/";
	...
	/**
	 * Gets the query. Public function
	 * 
	 * @return the query
	 */
	...
	/**
	 * Gets the origin. Public function
	 * 
	 * @return the origin
	 */
	...
	/**
	 * Gets the address. Public function
	 * 
	 * @return the address
	 */
	 ...
	 * Gets the file name.
	 *
	 * @return the file name, if the path is "/", then using default 
	...
	public String getFileName()
	{
		if (!path.equals("/"))
		{
			...
			String delims = "/";
			String[] pathes = path.split(delims);
